...
const contenidos: Record<Idioma, ContenidoIdioma> = {
  es: { empresa: '[Empresa]', acento: '#4338ca', bannerDesde: '#3730a3', bannerMedio: '#4338ca', bannerHasta: '#4f46e5', logo: false, logoVersion: null, categorias: categoriasEs, articulos: articulosEs, conversacion: conversacionEs, metricas: metricasEs },
  pt: { empresa: '[Empresa]', acento: '#4338ca', bannerDesde: '#3730a3', bannerMedio: '#4338ca', bannerHasta: '#4f46e5', logo: false, logoVersion: null, categorias: categoriasPt, articulos: articulosPt, conversacion: conversacionPt, metricas: metricasPt },
}
